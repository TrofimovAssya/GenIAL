...
from core.main import Processor, FileHandler
...
def small_sample(wc, bamfile) :
    fh = FileHandler(Sampler(wc, "../data/small_train_sample",
                             "../data/small_test_sample",
                             "../data/small_validation_sample",
                              sample=35000))
    fh.from_file(bamfile)
    
def normal_sample(wc, bamfile, suffix) :
    fh = FileHandler(Sampler(wc,
                             "../data/train_sample_" + suffix,
                             "../data/test_sample_" + suffix,
                             "../data/validation_sample_" + suffix,
                              sample=350000))
    fh.from_file(bamfile)
        
normal_sample(ED06_wc, ED06_path, "06")
normal_sample(ED39_wc, ED39_path, "39")